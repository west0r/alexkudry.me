...
export const ru: LocalizedStrings = {
    ...
    content: {
        facts: [
            {title: "10+", description: "Лет в разработке и менеджменте"},
            {title: "150+", description: "Часов практики консулитирования"},
            {title: "500+", description: "Часов доп. образования"},
            {title: "250+", description: "Часов личной психотерапии"},
        ],
        requests: [
            {
                problem: "Чувствуешь, что застрял в карьере? Не знаешь, куда двигаться?",
                resolution: "Составим индивидуальный план развития, исходя из твоих личных целей и ценностей"
            },
            {
                problem: "Страдаешь от неуверенности, синдрома самозванца или выгорания?",
                resolution: "Проработаем деструктивные паттерны и найдем точки опоры"
            },
            {
                problem: "Задачи и проекты буксуют, и уровень фрустрации растет?",
                resolution: "Проанализируем проблемы, найдем мотивацию и составим четкий план действий"
            },
            {
                problem: "Сложно находить общий язык с коллегами, руководством, возникают конфликты?",
                resolution: "Оценим ситуацию и выстроим эффективные стратегии коммуникации для достижения своих целей"
            },
            {
                problem: "Начал руководить командой, а все вокруг разваливается?",
                resolution: "Определим, что значит быть лидером, разберем ожидания компании и найдем путь к успеху"
            },
            {
                problem: "Команда не справляется с задачами или постоянно опаздывает с дедлайнами?",
                resolution: "Выявим слабые места и построим надежные процессы для повышения эффективности"
            },
            {
                problem: "Низкая инженерная культура и проблемы с качеством продукта?",
                resolution: "Создадим крепкую культуру и внедрим лучшие DevEx практики без потерь для бизнеса"
            },
            {
                problem: "Не нашел свою проблему в списке?",
                resolution: "Напиши мне и мы придумаем подходящие способы решения используя мой опыт"
            },
        ],
        talks: [
            {
        ...
        articles: [
            {
                "title": "Кого и как защищает дев-адвокат",
                "source": "Habr",
                "url": "https://habr.com/en/companies/inDrive/articles/718526/"
            },
            {
                "title": "FPS не падай, девайс не грейся",
                "source": "Habr",
                "url": "https://habr.com/en/companies/avito/articles/597417/"
            },
            {
                "title": "Swift + VK.API или история о SwiftyVK",
                "source": "Habr",
        ...
        skills: [
            {
                ...
                "description": "Я прошёл длинный путь в IT и знаю все нюансы, с которыми сталкиваются разработчики и менеджеры"
            },
            {
            ...
            {
                "title": "Методы КПТ",
                "description": "Использую знания о человеческой психике для работы с негативными убеждениями, когнитивными ошибками и самосаботажем"
            },
            {
                "title": "Тайм-менеджмент",
                "description": "Внедряю инструментам целеполагания и тайм-менеджмента для управлления рабочей нагрузкой, повышения продуктивности и снижения напряжение"
            },
            {
                "title": "Развитие конструктивных коммуникаций",
                "description": "Помогаю выстраивать эффективные коммуникации для здоровых и продуктивных рабочих отношений"
            }
        ],
        educations: [
            {
